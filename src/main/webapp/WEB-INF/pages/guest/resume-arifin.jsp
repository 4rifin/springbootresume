							...
							<div class="list-text">
								<div class="content">
										...
										<span class="icon-phone">: </span>+60172365985<br>
										 <br>
										 <div class="head-subtitle">Permanent Address
										 <br>
										 </div>
					...
					<div class="hp-info hp-simple pull-left hp-inline">
						<div class="">
							<div class="form-row">
								<div class="col-md-2">
								<address class="nm">
										<a href="https://springscrudjsf.herokuapp.com/"  target="_blank"><strong>CRUD with Spring JSF PrimeFaces with PostgreSQL</strong></a><br>
										<div class="head-subtitle">Apr 2020 <span class="icon-minus"></span> May 2020</div>
